...
cd /etc/VPS-MX
wget https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/VPS-MX.tar.xz >/dev/null 2>&1
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log | grep -w "nombre.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log | grep -w "IDT.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log | grep -w "tiemlim.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/tiemlim.log &>/dev/null
touch /usr/share/lognull &>/dev/null
wget https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/HELP -O /usr/bin/HELP &>/dev/null &>/dev/null
chmod 775 /usr/bin/HELP &>/dev/null
wget https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/SPR -O /usr/bin/SPR &>/dev/null &>/dev/null
chmod 775 /usr/bin/SPR &>/dev/null
wget -O /usr/bin/SOPORTE https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/SOPORTE.sh &>/dev/null
chmod 775 /usr/bin/SOPORTE &>/dev/null
SOPORTE &>/dev/null
wget -O /bin/rebootnb https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/rebootnb &>/dev/null
chmod +x /bin/rebootnb
wget -O /bin/resetsshdrop https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/resetsshdrop &>/dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/Version &>/dev/null
grep -v "^PasswordAuthentication" /etc/ssh/sshd_config >/tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
echo "PasswordAuthentication yes" >>/etc/ssh/sshd_config
v1=$(curl -sSL "https://github.com/Jaok04/TvRc-Mda/raw/refs/heads/main/ArchivosUtilitarios/Version")
